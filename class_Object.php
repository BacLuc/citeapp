		...
		if($this->new){
			$this->new=false;
				...
				if(count($this->properties)>0){
					if(isset($this->properties['http://citeapp.ch/voc.html#prename']) || isset($this->properties['http://citeapp.ch/voc.html#surname']))$this->newProperties['http://citeapp.ch/voc.html#fullname'] = '';
					...
					if(isset($this->properties['http://citeapp.ch/voc.html#surname'])){
							$this->properties['http://citeapp.ch/voc.html#fullname'].=" ".$this->properties['http://citeapp.ch/voc.html#surname'];
					}
				...
				if(count($this->newProperties)>0){
					if(isset($this->newProperties['http://citeapp.ch/voc.html#prename']) || isset($this->newPproperties['http://citeapp.ch/voc.html#surname']))$this->newProperties['http://citeapp.ch/voc.html#fullname'] = '';
					...
					if(isset($this->newProperties['http://citeapp.ch/voc.html#surname'])){
							$this->newProperties['http://citeapp.ch/voc.html#fullname'].=" ".$this->properties['http://citeapp.ch/voc.html#surname'];
						}
