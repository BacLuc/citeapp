...
if(isset($_POST)){
		...
		if(isset($_POST['action'])){
			...
			try{
				...
				elseif($_POST['action']== 'addProperty' && isset($_POST['oid']) && isset($_POST['property']) && isset($_POST['value']) ){
				...
				elseif($_POST['action']== 'removeProperty' && isset($_POST['oid']) && isset($_POST['property']) && isset($_POST['value']) ){
				...
				elseif($_POST['action']== 'addRelation' && isset($_POST['oid']) && isset($_POST['relation']) && isset($_POST['other_oid']) ){
					$RDFMed->addRelation($_POST['oid'], $_POST['relation'], $_POST['other_oid']);
					echo utf8_encode(json_encode(array('check' => 'suc')));
				
				
				}
				elseif($_POST['action']== 'removeRelation' && isset($_POST['oid']) && isset($_POST['relation']) && isset($_POST['other_oid']) ){
