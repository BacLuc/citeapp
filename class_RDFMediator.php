...
class RDFMediator
{
    ...
    function printToJsonForSearch ()
    {
        ...
        foreach ($this->resultList as $oid => $object) {
            ...
            $pushObject = array( 'type'      => $object->getType(), 'oid' => $oid, 'properties' => $properties,
                                 'levenprop' => $object->properties[$object->levenprop],
            );
    ...
    function printToJsonForGraph ()
    {
        ...
        foreach ($this->resultList as $oid => $object) {
            ...
            if (!isset($this->oidlist[$oid]) || true) {
                ...
                $pushObject = array( 'type'       => $object->getType(), 'label' => $label, 'oid' => $oid,
