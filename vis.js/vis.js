...
!function(e){
	if("object"==typeof exports)module.exports=e();
		...
		var f;
		"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.vis=e()}
		}
(function(){
...
Node.prototype.reCalcTitle = function(){
	...
	var toolbox = '<table border = "0" id="nodetable_'+this.id+'">';
	for( var j in this.properties){
		if(!(this.properties[j].isdeleted)){
			//toolbox += '<tr><td><input type="text" changed="0" value="'+this.properties[j].label+'"</td>';
			
			toolbox += '<tr><td><select id="oid'+this.id+'propCombobox'+j+'" nodeId="'+this.id+'" propId="'+j+'" class="property" ';
			//toolbox += 'onload=\'function(){alert("hi");$(function() {$( "#oid'+this.id+'propCombobox'+j+'" ).combobox();$( "#toggle" ).click(function() {$( "#oid'+this.id+'propCombobox'+j+'" ).toggle();});})}\'';
			toolbox += '></select></td>';
			//toolbox += '<script>$(function(){$("#oid'+this.id+'propCombobox'+j+'" ).autocomplete( "destroy" );});</script>';
			toolbox += '<script>$(function() {$( "#oid'+this.id+'propCombobox'+j+'" ).combobox();$( "#toggle" ).click(function() {$( "#oid'+this.id+'propCombobox'+j+'" ).toggle();});});</script>';
			...
			toolbox += '<td><select id="oid'+this.id+'objCombobox'+j+'"  nodeId="'+this.id+'" propId="'+j+'" class="object" ';
			//toolbox += 'onload=\'function(){$(function() {$( "#oid'+this.id+'objCombobox'+j+'" ).combobox();$( "#toggle" ).click(function() {$( "#oid'+this.id+'objCombobox'+j+'" ).toggle();});});}\'';
			toolbox += '></select></td>';
			//toolbox += '<script>$(function(){$("#oid'+this.id+'propCombobox'+j+'" ).autocomplete( "destroy" );});</script>';
			toolbox += '<script>$(function() {$( "#oid'+this.id+'objCombobox'+j+'" ).combobox();$( "#toggle" ).click(function() {$( "#oid'+this.id+'objCombobox'+j+'" ).toggle();});});</script>';
			toolbox += '<td> <button id="removeButton_'+this.id+'_'+j+'" nodeId="'+this.id+'" propId="'+j+'" onClick="graph.nodes['+this.id+'].removeProperty('+j+');" value="-">---</button></td></tr>';
		}	
	}
	...
	toolbox += '<button id="resetButton_'+this.id+'" oid="'+this.id+'" onClick="graph.nodes['+this.id+'].resetNode();" value="reset">reset</button>';
	
	//console.log(this.title);
	this.title=toolbox;
}

Node.prototype.getFrozenPopup= function(){
	var toolbox = '<table border = "0" id="nodetable_'+this.id+'">';
	for( var j in this.properties){
		if(!(this.properties[j].isdeleted)){
			//toolbox += '<tr><td><input type="text" changed="0" value="'+this.properties[j].label+'"</td>';
			
			toolbox += '<tr><td><select id="oid'+this.id+'propCombobox'+j+'frozen" nodeId="'+this.id+'" propId="'+j+'" class="property" ';
			//toolbox += 'onload=\'function(){alert("hi");$(function() {$( "#oid'+this.id+'propCombobox'+j+'" ).combobox();$( "#toggle" ).click(function() {$( "#oid'+this.id+'propCombobox'+j+'" ).toggle();});})}\'';
			toolbox += '></select></td>';
			//toolbox += '<script>$(function(){$("#oid'+this.id+'propCombobox'+j+'" ).autocomplete( "destroy" );});</script>';
			toolbox += '<script>$(function() {$( "#oid'+this.id+'propCombobox'+j+'frozen" ).combobox();$( "#toggle" ).click(function() {$( "#oid'+this.id+'propCombobox'+j+'frozen" ).toggle();});});</script>';
			...
			toolbox += '<td><select id="oid'+this.id+'objCombobox'+j+'frozen"  nodeId="'+this.id+'" propId="'+j+'" class="object" ';
			//toolbox += 'onload=\'function(){$(function() {$( "#oid'+this.id+'objCombobox'+j+'" ).combobox();$( "#toggle" ).click(function() {$( "#oid'+this.id+'objCombobox'+j+'" ).toggle();});});}\'';
			toolbox += '></select></td>';
			//toolbox += '<script>$(function(){$("#oid'+this.id+'propCombobox'+j+'" ).autocomplete( "destroy" );});</script>';
			toolbox += '<script>$(function() {$( "#oid'+this.id+'objCombobox'+j+'frozen" ).combobox();$( "#toggle" ).click(function() {$( "#oid'+this.id+'objCombobox'+j+'frozen" ).toggle();});});</script>';
			toolbox += '<td> <button id="removeButton_'+this.id+'_'+j+'frozen" nodeId="'+this.id+'" propId="'+j+'" onClick="graph.nodes['+this.id+'].removeProperty('+j+');" value="-">---</button></td></tr>';
		}
		
			
	}
	toolbox += '<button id="addButton_'+this.id+'frozen" oid="'+this.id+'" onClick="graph.nodes['+this.id+'].addProperty();" value="new Property">new Property</button>';
	toolbox += '<button id="saveButton_'+this.id+'frozen" oid="'+this.id+'" onClick="graph.nodes['+this.id+'].saveNode();" value="save">save</button>';
	if(!this.isPopupFrozen){
		toolbox += '<button id="freezeButton_"'+this.id+'" oid="'+this.id+'" onClick="graph.nodes['+this.id+'].freezePopup();" value="freeze">freeze</button>';
	}else{
		toolbox += '<button id="freezeButton_"'+this.id+'" oid="'+this.id+'" onClick="graph.nodes['+this.id+'].unFreezePopup();" value="unfreeze">unfreeze</button>';	
...
Node.prototype.freezePopup = function(){
	...
	node.innerHTML = this.getFrozenPopup();
	
	$('#mygraph').append(node.outerHTML);
	graph.popupObj = null;
	graph._checkShowPopup(graph.canvasToDOM({x:this.x+1000, y:this.y+1000}));
...
Node.prototype.addProperty = function(){
		...
		if(this.isPopupFrozen){
			$('#popupOfNodes'+String(this.id)).html(this.getFrozenPopup());
		}else{
		
			$('#popupOfNodes').html(this.getTitle());
		}
...
Node.prototype.saveNode = function(){
					...
					for(var i in this.properties){
							 if(this.properties[i].isedited){
									var form_data = {
										 action: 'removeProperty',
										 oid: this.id,
										 property: this.properties[i].oldtype,
										 value: this.properties[i].oldvalue
									...
									$.ajax({
										...
										success: function(response){
													...
													if(response.check== "suc"){
														...
														if(!(this.node.properties[this.propId].isdeleted)){
															var form_data = {
																 action: 'addProperty',
																 oid: this.node.id,
																 property: this.node.properties[this.propId].type,
																 value: this.node.properties[this.propId].value
															...
															$.ajax({
																...
																success: function(response){
																			if(response.check == "suc"){
																				this.node.properties[this.propId].oldvalue=this.node.properties[this.propId].value;
																				this.node.properties[this.propId].oldtype=this.node.properties[this.propId].type;
																				this.node.properties[this.propId].isedited=false;
...
Node.prototype.resetNode = function(){
	for(var i in this.properties){
		this.properties[i].value=this.properties[i].oldvalue;
		this.properties[i].type=this.properties[i].oldtype;
		this.properties[i].label=this.properties[i].oldlabel;
		this.properties[i].isedited=false;
	}	
...
Node.prototype.removeProperty = function(propId){
	
		this.properties[propId].isedited=true;
		this.properties[propId].isdeleted=true;
		this.reCalcTitle();
...
Node.prototype.setProperties = function(properties, constants) {
  ...
  if (properties.oldlabel !== undefined)          {this.oldlabel = properties.oldlabel;}
  ...
  if(this.label !== undefined){
			if(this.label == 'author'){
					this.image='icons/author.jpg';
					this.shape = 'image';
				}
			else if(this.label == 'text'){
					this.image='icons/text.jpg';
					this.shape = 'image';
				}
			else if(this.label == 'cite'){
					this.image='icons/cite.jpg';
					this.shape = 'image';
				}
...
Edge.prototype.positionBezierNode = function() {
  if (this.via !== null && this.via !== undefined && this.to !== null && this.to !== undefined && this.from !== null && this.from !== undefined ) {
 ...
 *                             backgroundColor, etc.
 */
function Popup(container, x, y, text, style, popupObj) {
  if (container) {
  ...
  this.frame.id="popupOfNodes";
  this.container.appendChild(this.frame);
  if(typeof popupObj === "Node"){
		$('#popupOfNodes').html(popupObj.getTitle());
	  }else{
		$('#popupOfNodes').html(text);
	}
}
...
var popupObj = show;
  ...
  if (show) {
    ...
    if(popupObj != undefined){
      ...
      if(popupObj.properties !== undefined){
		 // console.log("bin schon weiter");
		
			for(var i in popupObj.properties){
								console.log("$( '#obj"+popupObj.id+"propCombobox"+String(i)+" ).combobox()");
				
								$( "#obj"+popupObj.id+"propCombobox"+String(i) ).combobox();
								
								$( "#toggle" ).click(function() {
									$( "#obj"+popupObj.id+"propCombobox"+String(i)).toggle();
								});
								
								$( "#obj"+popupObj.id+"objCombobox"+String(i) ).combobox();
								$( "#toggle" ).click(function() {
									$( "#obj"+popupObj.id+"objCombobox"+String(i)).toggle();
								});
...
var manipulationMixin = {
  ...
  _createManipulatorBar : function() {
    ...
    //added By Lucius
    //this.editModeDiv.innerHTML += '<select id="MainObjCombobox" class="object"></select>';
...
Graph.prototype._checkShowPopup = function (pointer) {
  ...
  if (this.popupObj) {
    ...
    if (this.popupObj != lastPopupNode ) {
      ...
      var me = this;
      if (!me.popup && !me.popupObj.isPopupFrozen) {
		me.popupObj.reCalcTitle();
		
        me.popup = new Popup(me.frame, me.popupObj.getTitle(), this.popupObj);
      ...
      $('#popupOfNodes').html(this.popupObj.getTitle());
      me.popup.show();
...
Graph.prototype.callback = function(data){
		callback(data);
	}
